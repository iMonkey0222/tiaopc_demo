			...
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container">
						...
						<ul class="nav">
								<li class="active"><a href="{{ route('home') }}"><i class="icon-home icon-white"></i> Home</a></li>
								<li class="active"><a href="{{ URL::to('about-us') }}"><i class="icon-file icon-white"></i> About us</a></li>
								<li class="active"><a href="{{ URL::to('contact-us') }}"><i class="icon-file icon-white"></i> Contact us</a></li>
							</ul>
